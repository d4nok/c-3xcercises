...
#include <iostream> //Including the inpur-output stram header file
#include <iomanip>  //Including th egeader file for formatting

using namespace std; //Using the standard namespace

int main() //Using the standard namesapce
{
    int m1 = 5, m2 = 7 ;//Declaring and initializing two integers
    double d1 = 3.7, d2 = 8.0; //Declaring and initializing two doubles

    cout<<"\n\n Display arithmetic operation with mixed data type :\n";//Outputting a message for arithmetic operations
    ...
    cout <<""<< d1 << "-" << d2 << "=" << d1-d2 << endl;//Subtraction of integers
    cout <<""<< m1 << "-" << m2 << "=" << m1-m2 << endl;//Subtraction of doubles
